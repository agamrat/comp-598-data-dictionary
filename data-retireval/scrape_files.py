...
def read_json(reps, csv):
	...
	csv.write(str(congress) + "," + str(sponsor_district) + "," + str(committees) + "," + str(date_introduced) + "," + str(sponsor_party) + "," + str(sponsor_gender) + "," + str(sponsor_role) + "," + str(num_cosponsors) + "," + str(num_co_dem) + "," + str(status) + "," + ",".join(subjects) + "\n")
...
for p in person_info_arr:
	...
	if(len(info) > 18):
		reps[info[18]] = info
csv = open("/home/mike/Desktop/comp598-ass1/data_with_subjects.csv", "w")
